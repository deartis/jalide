...
<p align="center">
  <img src="../img/menu_options.png" width="30%" alt="Menu de Opções do Editor" />
</p>
...
<p align="center">
  <img src="../img/terminal_remote.png" width="30%" alt="Terminal Remoto SSH e Conexão" />
</p>
...
<p align="center">
  <img src="../img/gemma_config.png" width="30%" alt="Configuração da API Gemma" />
  <img src="../img/ai_assistant.png" width="30%" alt="Conversa com Assistente JAL" />
  <img src="../img/ghost_suggestion.png" width="30%" alt="Ghost Suggestions no Editor" />
</p>
...
- **Ghost Suggestions (Sugestões Fantasma)**:
  ...
  - Código implementado em [ghost_suggestion_bar.dart](file:///c:/Users/JAL/Documents/Projetos/jalide/mobile/widgets/ghost_suggestion_bar.dart).
...
- **Modelagem**:
  - Gerenciado por `ThemeProvider` em [jalide_theme.dart](file:///c:/Users/JAL/Documents/Projetos/jalide/mobile/lib/theme/jalide_theme.dart).
