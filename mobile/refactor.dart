...
void main() async {
  ...
  for (final file in files) {
    if (file.path.contains('jalide_theme.dart') || file.path.contains('main.dart')) continue;
    ...
    final stateMatch = RegExp(r'class\s+_[a-zA-Z0-9_]+State\s+extends\s+State<[^>]+>\s*\{').firstMatch(content);
    if (stateMatch != null) {
